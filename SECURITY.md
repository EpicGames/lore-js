...
This file covers the `@lore-vcs/sdk` JavaScript/TypeScript package and its
npm-published platform binaries. Vulnerabilities in the underlying Lore wire
protocol, `lore-capi`, or `loreserver` are also in scope — mention which
...
security@epicgames.com with "Lore JS SDK security" in the subject line.
